...
<div class="main-content">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">{{ $activities->unique('user_name')->count() }}</div>
        </div>
        <div class="stat-card">
            <div class="stat-label">IP Address Unik</div>
            <div class="stat-value">{{ $activities->unique('ip_address')->count() }}</div>
        </div>
    </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="user-info">
                                            ...
                                            <span class="user-nip">{{ $activity['pegawai_id'] }}</span>
                                        </div>
                                    </td>
                                    <td>
